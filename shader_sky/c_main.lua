...
function math.lerp(from, alpha, to) return from + (to-from) * alpha end
...
function getNormalAngle(rotation) return math.mod(rotation, 360) end
...
function getMoonPhaseValue() return moonPhase end
function isDynamicSkyEnabled() return dsEffectEnabled end