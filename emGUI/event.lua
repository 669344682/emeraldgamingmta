...
addEvent("ondxGridListSelect", true)
addEvent("ondxGridListItemDoubleClick", true)
addEvent("ondxProgressBarChange", true)
...
-- Makes use of event.luac, both files required for redirecting the correct events.
