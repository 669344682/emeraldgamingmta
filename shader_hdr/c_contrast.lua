...
function enableHDRShader()
	...
	if not bAllValid then
		outputChatBox("[SHADER] ERROR: Failed to create some effects, if this persists consider disabling the shader in the F10 settings.", 255, 0, 0)
		disableHDRShader()
	end
end
